...
apt install -y curl jq flatpak gnome-software gnome-shell gnome-shell-extensions software-properties-common libvlc-dev ffmpeg stacer timeshift
...
# ===============================
# Install ProtonVPN (Official Way)
# ===============================
echo "🔒 Installing ProtonVPN..."
# Add ProtonVPN repository
curl -fsSL https://repo.protonvpn.com/debian/public_key.asc | tee /etc/apt/trusted.gpg.d/protonvpn.asc
echo "deb https://repo.protonvpn.com/debian stable main" | tee /etc/apt/sources.list.d/protonvpn-stable.list
...
# ===============================
# Install Fragments via Flatpak
# ===============================
echo "🖼️ Installing Fragments..."
install_flatpak_app "com.github.rafaelmardojai.Fragments"
